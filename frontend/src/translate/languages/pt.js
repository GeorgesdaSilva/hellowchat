  ...
  pt: {
    translations: {
      ...
      reset: {
        ...
        toasts: {
          success: "Senha alterar com sucesso, enviamos a nova senha para seu email.",
          fail: "Erro ao recuperar sua senha, tente novamente!",
        },
        form: {
          name: "Nome",
          email: "Email",
      ...
      login: {
        ...
        buttons: {
          ...
          reset: "Esqueceu sua senha, recupere aqui.",
        },
      },
      auth: {
        toasts: {
